...
contract SafeHodl {
    ...
    function unlock(
        ...
        bytes32 passwordAndEmailHash = keccak256(
            abi.encodePacked(_email, _password)
        );
